...
import { type SkillMarketplaceItem, skillMarketplaceApi } from "@leros/store";
...
export function MarketplacePanel({ onCardClick, isAuthenticated = true }: MarketplacePanelProps) {
	...
	const filterCategory = isAuthenticated ? activeCategory : "";
	...
	}, [mounted, isAuthenticated, searchKeyword, filterCategory]);
	...
	}, [isAuthenticated, searchKeyword, filterCategory, hasMore]);
