				...
				<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
					{recent.map((item) => {
						...
						return (
							...
							>
								<div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[var(--leros-primary-soft)] text-[var(--leros-primary)] text-sm font-semibold group-hover:bg-[var(--leros-primary)] group-hover:text-white transition-colors">
